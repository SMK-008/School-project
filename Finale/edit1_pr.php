...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE prescriptions SET drugName='$drugName', drugAmount='$drugAmount',frequency='$frequency',patientName='$patientName'  WHERE p_pwd='$p_pwd'";
...
if (isset($_GET['delete'])) {
    $drugAmount = $_GET['delete'];
    
    $sql = "DELETE FROM prescriptions WHERE drugAmount='$drugAmount'";
    if ($conn->query($sql) === TRUE) {
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='edit.php?id=" . $row["drugName"] . "'>Edit</a> | <a href='?delete=" . $row["drugAmount"] . "' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>";
                echo "</tr>";
            }
        } else {
